...
from common.models.gan import ConditionalGan, ConditionalWGan, ConditionalVeeGan, ConditionalVeeWGan#,  Gan, ConditionalGan, VeeGan, ConditionalVeeGan, VeeWGan
...
class DnaSampleConditionalGan(ConditionalGan):
    def __init__(self, generator, discriminator, encoder, **kwargs):
...
@CustomObject
class DnaSampleConditionalWGan(ConditionalWGan):
    def __init__(self, generator, discriminator, encoder, **kwargs):
        super().__init__(generator, discriminator, **kwargs)
        self.encoder = encoder
        self.encoder.trainable = False
...
class DnaSampleConditionalVeeGan(ConditionalVeeGan):
    def __init__(self, generator, discriminator, reconstructor, encoder, **kwargs):
        super().__init__(generator, discriminator, reconstructor, **kwargs)
        self.encoder = encoder
        self.encoder.trainable = False
...
@CustomObject
class DnaSampleConditionalVeeWGan(ConditionalVeeWGan):
    def __init__(self, generator, discriminator, reconstructor, encoder, **kwargs):
        super().__init__(generator, discriminator, reconstructor, **kwargs)
        self.encoder = encoder
        self.encoder.trainable = False
...
# @CustomObject
# class DnaSampleConditionalVeeGan(ConditionalVeeGan):
#     def __init__(self, generator, discriminator, reconstructor, encoder, encoder_batch_size=512, **kwargs):
#         super().__init__(generator, discriminator, reconstructor, **kwargs)
#         self.encoder = encoder
#         self.encoder.trainable = False
#         self.encoder_batch_size = encoder_batch_size
...
# @CustomObject
# class DnaSampleVeeWGan(VeeWGan):
#     def __init__(self, generator, discriminator, reconstructor, encoder, encoder_batch_size=512, **kwargs):
#         super().__init__(generator, discriminator, **kwargs)
#         self.encoder = encoder
#         self.encoder.trainable = False
